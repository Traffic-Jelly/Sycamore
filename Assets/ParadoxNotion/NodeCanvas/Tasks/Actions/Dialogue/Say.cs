...
namespace NodeCanvas.Tasks.Actions{
	...
	public class Say : ActionTask<IDialogueActor> {
		...
		protected override string info{
			get { UnityEngine.Debug.Log ("getting shit on"); return string.Format("<i>' {0} '</i>", (statement.text.Length > 30? statement.text.Substring(0, 30) + "..." : statement.text) ); }
		}
		...
		protected override void OnTaskInspectorGUI(){
			...
			statement.waitForInput = UnityEditor.EditorGUILayout.Toggle ("Wait For Input", statement.waitForInput);
