	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 temp_cast_6 = (( (0.0 + (( simplePerlin3D2 + ( simplePerlin3D17 * 0.5 * ( 1.0 - saturate( ( 2.0 - _Octaves ) ) ) ) + ( simplePerlin3D23 * 0.25 * ( 1.0 - saturate( ( 3.0 - _Octaves ) ) ) ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) + _Bias )).xxxx;
...
/*ASEBEGIN
Version=15301
383;92;1258;735;1066.868;178.519;1.999014;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1200,432;Float;False;Property;_Offset;Offset;6;1;[HideInInspector];Create;True;0;0;False;0;0;14.03066;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-96,272;Float;False;Property;_Octaves;Octaves;3;0;Create;True;0;0;False;0;1;1.5;1;4;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=94A94A1C6F036D60FA636F8E4230615DCC8E58A2